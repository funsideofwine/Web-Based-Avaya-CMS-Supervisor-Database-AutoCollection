#remove raw file
Remove-Item "C:\xampp\htdocs\avayareports\scripts\scheduledreport1.sql" | Where { ! $_.PSIsContainer }

$output = "C:\xampp\htdocs\avayareports\scripts\scheduledreport1.sql"
